...
export default function Hero() {
  return (
    <div className="relative h-full w-full bg-hero bg-cover bg-center bg-no-repeat">
      <div className="">
        <h1 className="pt-[8rem] text-center text-5xl font-extrabold text-white md:pt-[6rem] md:text-8xl">
      ...
      <svg
        ...
        stroke-width="1.5"
        stroke="currentColor"
        class="absolute bottom-1 left-[50%] h-6 w-6 self-center text-center text-sm text-white"
      >
        <path
